...
<link rel="stylesheet" type="text/css" href="/resources/css/noticeManage.css">
</head>
                   ...
                   <c:choose>
                   	...
                   	<c:when test="${requestScope.map.list != null}">
                    		...
                    		<c:forEach var="n" items="${requestScope.map.list}">
                        		<tr>
                            		<td> <c:out value="${n.getNoticeNo()}" /> </td>
                            		
                            		<td>
                            			<c:url var="url" value="/admin/noticeEdit.do" >
											<c:param name="currentPage">${requestScope.map.currentPage } </c:param>
											<c:param name="noticeNo"> ${n.getNoticeNo() } </c:param>
										</c:url>
										
									<a href= "${url}" style="text-decoration:none; "> <c:out value="${n.getSubject()}" /> </a>
									</td>
										                        		                                                   
                            		<td> <c:out value="${n.getRegDate()}" /> </td>
                            		<td> <c:out value="${n.getViewCount()}" /> </td>
                            		<td> <c:out value="${n.getDelYN()}" /> </td>
                            		<td> <input type="checkbox" value="${n.noticeNo}"> </td>
                        		</tr>
                        	</c:forEach>
